 ...
 * @LastEditTime: 2020-10-01 17:51:32
...
<template>
  <el-card class="box-card">
    <el-page-header content="更新患者信息" style="margin-left: 2%;margin-bottom: 2%;" @back="goBack" />
...
export default {
  ...
  mounted() {
    ...
    this.ruleForm.orgCode = this.$route.params.orgCode
    this.ruleForm.patientName = this.$route.params.patientName
    this.ruleForm.genderCode = this.$route.params.genderCode
    this.ruleForm.birthDate = this.$route.params.birthDate
    this.ruleForm.socialNo = this.$route.params.socialNo
    this.ruleForm.telecom = this.$route.params.telecom
    this.ruleForm.email = this.$route.params.email
    this.ruleForm.identityType = this.$route.params.identityType
    this.ruleForm.identityNo = this.$route.params.identityNo
    this.ruleForm.homeFullAddress = this.$route.params.homeFullAddress
  ...
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.loading = true
          updatePatient(JSON.stringify(this.ruleForm)).then(() => {
            this.$message({
              message: '更新成功',
              type: 'success'
            })
